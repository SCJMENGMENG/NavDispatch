...
export default class NavigatorBar extends React.Component{
            ...
            return (
                ...
                >
                    <Image resizeMode='stretch'
                           style={[styles.backImg, backImgStyle] }
    ...
    _renderOptView() {
        const {
            firstLevelIconFont,
            secondLevelIconFont,
            firstLevelIconFontStyle,
            secondLevelIconFontStyle,
            optTitle,
            optTitleStyle,
            firstLevelClick,
            secondLevelClick,
            thirdLevelIconFont,
            thirdLevelIconFontStyle,
            thirdLevelClick,
            msgCount,
            optImgStyle,
            optImg,
            ...
            return(
                <View style={ styles.optMenuView }>
                    <TouchableOpacity
                        ...
                        onPress={ firstLevelClick }
                        style={ styles.firstLevelView }>
                        <Image style={[ styles.optImg, optImgStyle]} source={optImg}/>
                    </TouchableOpacity>
                </View>
            )
        }
    ...
    render(){
        const { style, imgTitle, titleContainer,titleStyle } = this.props;
        let title = ''
        if (this.props.title) {
            title = this.props.title
        } else if (this.props.router && this.props.router.state && this.props.router.state.params) {
                                        ...
                                        return(
                                            <TouchableOpacity activeOpacity={0.8} onPress={()=>{
                                                ...
                                                <View style={{flexDirection: 'row',alignItems: 'center'}}>
                                                    <Text style={ [styles.title, titleStyle] } ellipsizeMode='middle' numberOfLines={ 1 }>{ title || '' }</Text>
